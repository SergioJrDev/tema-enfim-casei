...
<?php endif; ?>
		...
		<h2 class="animate delay to-top title-descr tab-bottom font-poppins active"><?php _e( 'Login', 'woocommerce' ); ?></h2>

		<form class="woocomerce-form woocommerce-form-login login max-width-content" method="post">
		<?php 
			$error_url = $_GET['e'];
			if($error_url) { ?>
